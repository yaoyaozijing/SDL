...
//	{ MAKE_CONTROLLER_ID( 0x1532, 0x0037 ), k_eControllerType_XBox360Controller, NULL },	// Razer Sabertooth
	...
	{ MAKE_CONTROLLER_ID( 0x20bc,	0x5076 ), k_eControllerType_UnknownNonSteamController, "Beitong Zeus 2" },
	{ MAKE_CONTROLLER_ID( 0x20bc,	0x5073 ), k_eControllerType_UnknownNonSteamController, "Beitong Zeus 2" },
